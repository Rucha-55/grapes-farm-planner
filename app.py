...
from database import (
    ...
    users_collection, products_collection, reviews_collection, orders_collection
)
...
app.config['MONGO_URI'] = os.environ.get('MONGO_URI', 'mongodb+srv://smshelke:smshelke370122@cluster0.l2jnk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0')
...
#for grape type
# Set up Gemini API
GEMINI_API_KEY1 = "AIzaSyDNh4WcEpxf0BYxzYw3TEqcScTdW2YGauw"
genai.configure(api_key=GEMINI_API_KEY1)
gemini_model = genai.GenerativeModel('gemini-1.5-flash')

# Load the trained model
try:
    with open('grape_variety_model.pkl', 'rb') as file:
        model1 = pickle.load(file)
except:
    print("Error loading model. Please ensure grape_variety_model.pkl exists in the same directory.")

# OpenWeather API key
API_KEY1 = "95d7a89a500f832e59c95275707caffb"
...
def validate_parameters(data):
    ...
    valid_ranges = {
        "Temperature (°C)": (10, 38),
        "Humidity (%)": (6, 35),  # Updated for air humidity (not soil)
        "Soil pH": (4.5, 8.5),
        "Soil Moisture (%)": (10, 60),
        "N (Nitrogen)": (50, 300),
        "P (Phosphorus)": (10, 150),
...
# Configuration
LANGFLOW_ID = "10442f21-df66-46c7-9f8e-112f6882a6db"
FLOW_ID = "81f9aaa9-ffca-4c31-90c9-8f1639128415"
BASE_API_URL = "https://api.langflow.astra.datastax.com"
TOKEN = "AstraCS:EYdHNuvjZBAjCyaAtUnNlqhX:03722c0877e244856ad9da742fd504e4d265857e6f7ed7f29a417809c43761e5"
GEMINI_API_KEY = "AIzaSyBs3OFCZVvDdaW4TqpEo1z8ztvM7epDGEQ"  # Replace with your actual API key
...
def chat():
    try:
        ...
        # If no file, process text with Langflow
        return process_text_with_langflow(message)
...
def process_text_with_langflow(message):
    ...
    try:
        ...
        payload = {
            "contents": [
                {
                    "parts": [
                        {"text": query if query else "What's in this image?"},
                        {
                            "inline_data": {
...
API_KEY = '57c1783a1ff96434fc4b033f7c898f05'
...
def get_weather_insights():
    ...
    try:
        ...
        api_key = "AIzaSyBs3OFCZVvDdaW4TqpEo1z8ztvM7epDGEQ"
